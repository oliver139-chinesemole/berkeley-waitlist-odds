...
live/latest.json                                  # last observation of every section of a course with a full or waitlisted one, reserved_count and open_reserved included, for the site (scraper/live.py; rewritten each run, continue-on-error; since 2026-09-20, selection widened and the two reserved columns added 2026-09-24)
```
