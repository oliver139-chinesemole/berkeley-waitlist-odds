# Backtest: Fall 2026 temporal (instruction)

Split `temporal`, horizon `instruction`: 211446 training rows, 0 scored test rows, 0 test rows past their horizon at joining and 209612 whose follow-up ended before their horizon (neither scored).
